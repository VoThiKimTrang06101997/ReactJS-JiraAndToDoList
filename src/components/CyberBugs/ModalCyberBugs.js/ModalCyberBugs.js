          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="container-fluid">
                <div className="row">
                  <div className="col-8">
                    <p className="issue text-danger font-weight-bold">
                    ...
                    <div className="status">
                      ...
                      >
                        {arrStatus.map((status, index) => {
                          ...
                          // if (taskDetailModal.statusId === status.statusId) {
                          //   return (
                          //     <option key={index} selected value={status.statusId}>
                          //       {status.statusName}
                          //     </option>
                          //   );
                          // } else {
                        ...
                        <div className="col-6 mt-2 mb-2">
                          ...
                          <Select
                            options=  {projectDetail.members?.filter(mem=>{
                              ...
                              return (
                                {value: mem.userId, label: mem.name}
                                // <option key={index} value={mem.userId}>{mem.name}</option>
                              );
                            })}
                            optionFilterProp="label" value="+ Add More"
                           style={{width: "100%"}} name="listUser" className="form-control" onSelect={(value) => {
                            if(value == "0") {
                              return;
                            }
